<div class="bg-white rounded-2xl overflow-hidden shadow-lg transition-transform duration-300 hover:scale-[1.03]" data-aos="fade-up">
    ...
    <div class="relative group">
        <img src="{{ asset($post->landscape_image) }}" alt="{{ $post->title }}" class="w-full h-56 object-cover transition-transform duration-300 group-hover:scale-105">
    ...
    <div class="p-6">
        ...
        <!-- Deskripsi -->
        <p class="text-gray-600 mt-4 line-clamp-3">{{ $post->description }}</p>

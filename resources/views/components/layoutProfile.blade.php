            ...
            <div class="p-4">
                ...
                <nav>
                    <ul class="space-y-1">
                        ...
                        <li>
                            <a href="{{ route('artikel') }}" class="sidebar-menu {{ request()->routeIs('artikel') ? 'active' : '' }}">
                                <i class="ri-article-line"></i>
                                <span>Artikel Saya</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('disukai') }}" class="sidebar-menu {{ request()->routeIs('disukai') ? 'active' : '' }}">
                                <i class="ri-heart-line"></i>
                                <span>Artikel Disukai</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('pengaturan') }}" class="sidebar-menu {{ request()->routeIs('pengaturan') ? 'active' : '' }}">
